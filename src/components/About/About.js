      ...
      <div className="Container">
        ...
        <ScrollAnimation animateIn="fadeInLeft">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
            Hello! My name is <strong>Komal Sha</strong>. I'm originally from Muzaffarpur, Bihar, and currently have been living in Delhi. During my time here, I gained valuable experience which greatly enhanced my work ethic, communication skills, and adaptability.
            </ScrollAnimation>
